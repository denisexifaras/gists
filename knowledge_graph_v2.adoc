...
But not all topics have the same importance. For example, computational thinking is should have more weight than JavaScript. There is inherent hierarchy and nesting between our topics. Also, different nodes will carry different types of content (potentially).

This should incorporated because:
