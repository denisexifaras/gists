...
(a {name:"Input"})-[:related]->(b:Field {name:"Data"}),
(b {name:"Data"})-[:related]->(a {name:"Input"}),
(e {name:"Servers"})-[:related]->(f {name:"Cloud"}),
(f {name:"Cloud"})-[:related]->(e {name:"Servers"}),
(i {name:"UN Data"})-[:related]->(b {name:"Data"}),
(b {name:"Data"})-[:related]->(i {name:"UN Data"});
